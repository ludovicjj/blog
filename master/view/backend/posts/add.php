    ...
    <div class="container admin">        
        ...
        <form method="post" class="form-group">
            ...
            <div class="form-group">
                ...
                <input id="title" name="title" class="form-control champs"/>
            </div>
            <div class="form-group">
                <label for="intro">Introduction</label>
                <textarea id="intro" name="intro" class="form-control champs"></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input id="image" name="image" class="form-control champs"/>
            </div>
